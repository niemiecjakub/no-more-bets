...
export function AgentPageClient({
    ...
    initialBankroll?: AgentDashboardBankrollWidget | null;
}) {
    ...
    const [bankrollWidget, setBankrollWidget] = useState<AgentDashboardBankrollWidget | null>(initialBankroll);
    ...
    const [isBankrollLoading, setIsBankrollLoading] = useState(initialBankroll == null);
        ...
        <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
            <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <AgentDashboardGreeting bankroll={bankrollWidget} />
                    <AgentSeasonFilter
