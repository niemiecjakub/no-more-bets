...
{
  [HttpGet("memories")]
  public async Task<ActionResult<PagedResponse<MemoryListItemDto>>> GetMemories(
    ...
    CancellationToken cancellationToken = default)
  {
    ...
    return Ok(PagedResponseFactory.Create(rows, hasMore, row => row.UpdatedAt, row => row.Id));
  }
}
