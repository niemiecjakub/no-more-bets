...
public class GetBankrollEntriesPageHandlerTests
{
  ...
  public async Task Handle_PassesEntryNamesToRepository_WhenFilterProvided()
  {
    ...
    _bankrollRepository
      .GetEntriesPageAsync(15, null, null, entryNames, Arg.Any<CancellationToken>())
      .Returns(page);
  ...
  public async Task Handle_PassesNullEntryNames_WhenNoFilterProvided()
  {
    ...
    _bankrollRepository
      .GetEntriesPageAsync(15, null, null, null, Arg.Any<CancellationToken>())
      .Returns(page);
  ...
  public async Task Handle_ReturnsHasMore_WhenRepositoryIndicatesMoreFilteredPages()
  {
    ...
    _bankrollRepository
      .GetEntriesPageAsync(1, null, null, entryNames, Arg.Any<CancellationToken>())
      .Returns(page);
