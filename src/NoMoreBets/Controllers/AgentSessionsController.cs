...
public class AgentSessionsController(AppDbContext db) : ControllerBase
{
  ...
  public async Task<ActionResult<PagedResponse<AgentSessionListItemDto>>> GetAgentSessions(
    ...
    CancellationToken cancellationToken = default)
  {
    ...
    return Ok(PagedResponseFactory.Create(items, hasMore, item => item.StartedAt, item => item.Id));
  }
